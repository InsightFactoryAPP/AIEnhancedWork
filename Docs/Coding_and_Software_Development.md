...
| [Pi](https://pi.dev/) | A minimal, customizable terminal coding-agent harness that runs locally across many model providers. | [<img src="../Images/Licence/opensource.svg" alt="opensource" width="90" height="25" />](https://opensource.com/resources/what-open-source) | <img src="../Images/Pricing/free.svg" alt="free" width="80" height="20" /> |
...
| [YYLO](https://github.com/yylo-dev/yylo) | An open-source command-line orchestrator for coding agents, with typed task, validation, and merge flows and receipt-backed repository changes. | [<img src="../Images/Licence/opensource.svg" alt="opensource" width="90" height="25" />](https://opensource.com/resources/what-is-open-source) | <img src="../Images/Pricing/free.svg" alt="free" width="80" height="20" /> |
