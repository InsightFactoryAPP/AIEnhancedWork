...
| [LeptonAI](https://www.nvidia.com/en-us/data-center/dgx-cloud-lepton/) | A cloud platform for deploying and running AI applications; now part of NVIDIA (DGX Cloud Lepton). | Large Panel of Open source Models | [<img src="../Images/Pricing/Freemium.svg" alt="Freemium" width="80" height="20" />](https://builtin.com/articles/freemium)  |
